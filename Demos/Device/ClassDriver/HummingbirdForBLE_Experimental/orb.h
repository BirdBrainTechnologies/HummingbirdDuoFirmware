...
uint8_t  sensor_broadcast = 0; // Turns sensor broadcasting on or off
volatile uint8_t  sensor_broadcast_count = 0; // Counter used to determine when to broadcast sensors
